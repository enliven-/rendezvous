...
class AnsweredQuestionsControllerTest < ActionController::TestCase
  ...
  test "should create answered_question" do
    assert_difference('AnsweredQuestion.count') do
      post :create, answered_question: { answer_id: @answered_question.answer_id, question_id: @answered_question.question_id, user_id: @answered_question.user_id }
    end
  ...
  test "should update answered_question" do
    patch :update, id: @answered_question, answered_question: { answer_id: @answered_question.answer_id, question_id: @answered_question.question_id, user_id: @answered_question.user_id }
    assert_redirected_to answered_question_path(assigns(:answered_question))
  end
